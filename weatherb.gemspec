...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{A simple Ruby gem that can tell you all about the weather, superb!}
  spec.description   = %q{Weatherb comes from weather + rb (ruby file extension). It's basically a Ruby gem for retrieving data about weather using the ClimaCell API in a simple way.}
